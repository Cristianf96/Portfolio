...
const Home = () => {
    return (
        <div className="mx-auto h-screen flex flex-col items-center justify-center bg-gray-900">
            <div className='pt-32 md:pt-80 lg:pt-48 flex flex-col justify-center'>
            ...
            <div className='pt-10 md:pt-40 lg:pt-28 flex flex-col items-center justify-center'>
