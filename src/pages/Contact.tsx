...
const Contact = () => {
    ...
    return (
        <div className="flex min-h-screen w-full items-center justify-center bg-gray-900">
            ...
            <div className='flex flex-col md:flex-row md:space-x-6 space-y-6 md:space-y-0 w-full max-w-4xl p-10 lg:max-w-6xl text-white item justify-center'>
                <div className='flex flex-col space-y-8 justify-between'>
                    <div>
                        <motion.h1 initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0, transition: { duration: 0.75 } }} className='font-mono font-bold text-4xl md:text-5xl tracking-wide'>Contactame</motion.h1>
                        <motion.p initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0, transition: { duration: 0.75, delay: 0.25 } }} className='pt-2 text-gray-100 text-sm md:text-lg'>
                            Si tienes alguna idea y quieres que haga parte, puedes contactarme.
                        </motion.p>
                    </div>
                    <div className='flex flex-col space-y-4'>
                        <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0, transition: { duration: 0.75, delay: 0.50 } }} className='inline-flex space-x-2 items-center'>
                        ...
                        <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0, transition: { duration: 0.75, delay: 0.75 } }} className='inline-flex space-x-2 items-center'>
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 md:h-7 md:w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                                <path strokeLinecap="round" strokeLinejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                            </svg>
                            <span className='md:text-xl'>cb961218@gmail.com</span>
                        </motion.div>
                        <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0, transition: { duration: 0.75, delay: 1 } }} className='inline-flex space-x-2 items-center'>
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 md:h-7 md:w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                    ...
                    <div className='flex space-x-4 text-lg'>
                        <motion.a initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0, transition: { duration: 0.75, delay: 1.25 } }} href="https://github.com/Cristianf96" target={'_blank'}>
                        ...
                        <motion.a initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0, transition: { duration: 0.75, delay: 1.50 } }} href="https://www.linkedin.com/in/cristian-barragan-ab9149225/" target={'_blank'}>
		...
		C310,145.43,300.549,94.761,230.454,94.761z"/>
                ...
                <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0, transition: { duration: 0.75, delay: 2 } }} className='flex flex-col space-y-4 bg-gray-800 rounded-xl shadow-lg p-8 md:w-[70rem] lg:w-[40rem]'>
                    <div>
                    ...
                    <motion.button whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }} onClick={onSubmit} className='inline-block self-end bg-gray-600 text-white font-bold rounded-lg px-4 py-2 uppercase text-sm md:text-base'>
                        Enviar
                    </motion.button>
                </motion.div>
            </div>
